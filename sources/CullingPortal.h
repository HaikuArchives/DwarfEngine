#ifndef D_CULLING_PORTAL_H_
#define D_CULLING_PORTAL_H_
...
namespace dwarf
{
	...
	class CullingPortal : public Portal
	{
	public:
		
		CullingPortal()	{}
		CullingPortal(const Object &target, const ListArray<poly_vertex> &polygon);
